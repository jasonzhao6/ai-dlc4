# Unit 4: Browsing, Search & Sort — Tasks
...
- [ ] 6. Upload updated React build to frontend S3 bucket
- [ ] 7. Verify search filters files correctly in browser
- [ ] 8. Verify sort works for all three columns (name, date, size) in both directions
